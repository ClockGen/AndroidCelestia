...
class ExampleInstrumentedTest {
    ...
    protected fun <T: Activity> tryAcquireScenarioActivity(activityScenario: ActivityScenario<T>): T {
    ...
    fun screenshotItem(item: TestItem, name: String) {
        ...
        Thread.sleep(if (firstTest) 60000 else 5000)
        firstTest = false
