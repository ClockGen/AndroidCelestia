...
@Composable
fun SelectionInputDialog(onDimissRequest: () -> Unit, title: String? = null, selectedIndex: Int, items: List<String>, selectionChangeHandler: (Int) -> Unit, confirmHandler: () -> Unit) {
    AlertDialog(
