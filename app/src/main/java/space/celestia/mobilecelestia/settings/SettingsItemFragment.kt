...
import space.celestia.mobilecelestia.settings.viewmodel.SettingsMainViewModel
import space.celestia.mobilecelestia.utils.CelestiaString
import javax.inject.Inject

@Composable
fun SettingsMainScreen(paddingValues: PaddingValues, onItemTap: (SettingsItem) -> Unit, modifier: Modifier = Modifier) {
